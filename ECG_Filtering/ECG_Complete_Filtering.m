...
function [ecg_filtered] = ECG_Complete_Filtering(raw_ecg,fs)
    utils = ECGutils;
    ...
    ecg_noBLW = FIR_Remove_BLW(ecg_noPowerline,fs,fc);
    ...
    highpass_freq = 0.5;
    lowpass_freq = 40;
    ecg_noArtifacts = ECG_Band_Pass_Filter(ecg_noBLW, fs, highpass_freq, lowpass_freq);
